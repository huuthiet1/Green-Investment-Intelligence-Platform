...
const SIDEBAR_ITEMS = [
  ...
  { label: "ESG", icon: Leaf },
  { label: "Báo cáo", icon: FileWarning },
  { label: "Bảo mật", icon: ShieldCheck },
];

const QUICK_ACTIONS = [
  { id: 1, title: "Duyệt dự án chờ xử lý", icon: ClipboardList },
  { id: 2, title: "Quản lý người dùng", icon: Users },
  { id: 3, title: "Kiểm tra báo cáo vi phạm", icon: FileWarning },
  { id: 4, title: "Xem nhật ký bảo mật", icon: ShieldCheck },
];

const CHART_BARS = [42, 55, 61, 70, 78, 86, 93];
const STAT_ICONS = [FolderKanban, Users, CircleDollarSign, Leaf];
  ...
  return (
    <div className="grid grid-cols-5 items-center px-4 py-4 text-sm">
      <div className="col-span-2 min-w-0">
        ...
        <div className="truncate text-white/50">{owner}</div>
      </div>
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h2 className="text-2xl font-bold">Bảng điều khiển quản trị hệ thống</h2>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="hidden items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-white/60 md:flex">
            ...
            <span className="text-sm">Tìm kiếm người dùng, dự án, ESG...</span>
          </div>
  ...
  return (
    <Card className="p-6">
      <SectionTitle
        ...
        title="Tăng trưởng hệ thống & chất lượng ESG"
        right={
        ...
        <div className="flex h-full flex-col justify-between">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h4 className="text-lg font-semibold">Tăng trưởng nền tảng</h4>
            </div>
...
function QuickActionsCard() {
  return (
    <Card className="p-6">
      <SectionTitle eyebrow="Thao tác nhanh" title="Quản trị nhanh" />
      ...
      <div className="mt-6 rounded-2xl border border-white/10 bg-slate-900/70 p-4">
        ...
        <p className="mt-2 text-sm text-white/75">
          10 phút trước từ hệ thống quản trị, báo cáo vi phạm và phân hệ ESG.
        </p>
      </div>
    </Card>
  );
    ...
    <Card className="p-6">
      ...
      <div className="mt-6 rounded-2xl border border-white/10 bg-gradient-to-r from-green-500/10 to-cyan-500/10 p-5">
        ...
        <p className="mt-2 text-sm leading-6 text-white/75">
          Ưu tiên kiểm tra các dự án pending có ESG trên 80 và báo cáo vi phạm
          mới để giữ chất lượng nền tảng ổn định.
        </p>
      </div>
    </Card>
  );
    ...
    api
      ...
      .catch(() => {
        setData({
          ...
          summary: [
            { id: 1, label: "Dự án chờ duyệt", value: 16 },
            { id: 2, label: "Báo cáo vi phạm", value: 7 },
            { id: 3, label: "Admin online", value: 3 },
          ],
          projects: [
            {
              id: 1,
              name: "Solar Farm Tây Ninh",
              owner: "Công ty Green Sun",
              esg: 91,
              capital: "20 tỷ",
              status: "pending",
            },
          ...
          activities: [
            {
              id: 1,
              content: "Admin vừa duyệt dự án Solar Farm Tây Ninh.",
              time: "5 phút trước",
            },
            {
              id: 2,
              content: "Có 2 báo cáo vi phạm mới cần xử lý.",
              time: "15 phút trước",
            },
            {
              id: 3,
              content: "Người dùng mới đăng ký tài khoản doanh nghiệp.",
              time: "30 phút trước",
            },
          ],
        });
